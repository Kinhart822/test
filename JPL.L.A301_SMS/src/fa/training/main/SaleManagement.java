...
//		---------------- 5 ----------------	
		...
		// addCustomer
		CustomerDAO customerDAO122414 = new CustomerDAOImpl();
...
//		---------------- 7 ----------------	
    	...
    	// updateCustomer
		CustomerDAO customerDAO122414334 = new CustomerDAOImpl();
...
//		---------------- 6 ----------------	
    	...
    	// deleteCustomer
		CustomerDAO customerDAO122414324334 = new CustomerDAOImpl();
...
//		---------------- 2 ----------------	
		...
		OrderDAO orderDAO12 = new OrderDAOImpl();
...
//		---------------- 4 ----------------	
		...
		// computeOrderTotal
	    OrderDAO orderDAO1343513 = new OrderDAOImpl();
...
//		-----------------------------------	
		...
		order = new Order(2, sqlDate1, 2, 2, 600.00);
		try {
...
//												------------------- LineItem -------------------
		...
		LineItemDAO lineItemDAO1 = new LineItemDAOImpl();
...
//		---------------- 3 ----------------
        ...
        LineItemDAO lineItemDAO12 = new LineItemDAOImpl();
        try {
